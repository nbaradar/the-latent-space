...
# Configuration
#######################################
# make sure to set the PATH variable to include necessary directories
export PATH="/usr/local/bin:/opt/homebrew/bin:/usr/bin:/bin:/usr/sbin:/sbin"

# Add your vault paths here
VAULT_PATHS=(
  "/Users/naderbaradar/Documents/test_vault"
)

# Master log file
MASTER_LOG="/Users/naderbaradar/obsidian-autosync-master.log"
