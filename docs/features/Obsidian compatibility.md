...
It also ships with support for [frontmatter parsing](https://help.obsidian.md/Editing+and+formatting/Properties) with the same fields that Obsidian uses through the [[quartz/docs/plugins/Frontmatter]] transformer plugin.
...
This functionality is provided by the [[ObsidianFlavoredMarkdown]], [[quartz/docs/plugins/Frontmatter]] and [[CrawlLinks]] plugins. See the plugin pages for customization options.
